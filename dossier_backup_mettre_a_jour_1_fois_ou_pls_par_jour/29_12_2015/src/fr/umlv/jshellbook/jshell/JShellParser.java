...
public class JShellParser {
	 ...
	 */
	/*We haven't find the right way to delegates more
	 * the Parsing because we don't want to multiply
	 * the number of String to make
	 * */
	...
	/*To split the line correctly, we must
	 * conserve the works that has been done or not
	 * and so must we work with the same String.
	 * Because of that we couldn't delegates that much.
	 * */
	...
	/*
	 * We must conserve a "link" to knows where
	 * we are in the code. So must we knows the
	 * content of the line. In this case
	 * We would'nt delegates that much the works because
	 * of this link that shouldn't be shared.
	 * */
